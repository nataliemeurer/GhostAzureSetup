...
define('ghost/components/gh-alert', ['exports', 'ember'], function (exports, Ember) {
    ...
    var AlertComponent = Ember['default'].Component.extend({
        tagName: "article",
...
define('ghost/controllers/signin', ['exports', 'ember', 'ghost/mixins/validation-engine', 'ghost/utils/ajax'], function (exports, Ember, ValidationEngine, ajax) {

    'use strict';

    var SigninController = Ember['default'].Controller.extend(ValidationEngine['default'], {
        validationType: "signin",
...
define('ghost/initializers/authentication', ['exports', 'ember', 'simple-auth/session', 'simple-auth-oauth2/authenticators/oauth2'], function (exports, Ember, Session, OAuth2) {
...
define('ghost/mixins/validation-engine', ['exports', 'ember', 'ember-data', 'ghost/utils/ajax', 'ghost/utils/validator-extensions', 'ghost/validators/post', 'ghost/validators/setup', 'ghost/validators/signup', 'ghost/validators/signin', 'ghost/validators/setting', 'ghost/validators/reset', 'ghost/validators/user', 'ghost/validators/tag-settings'], function (exports, Ember, DS, ajax, ValidatorExtensions, PostValidator, SetupValidator, SignupValidator, SigninValidator, SettingValidator, ResetValidator, UserValidator, TagSettingsValidator) {
...
define('ghost/routes/application', ['exports', 'ember', 'simple-auth/mixins/application-route-mixin', 'simple-auth/configuration', 'ghost/mixins/shortcuts-route', 'ghost/utils/ctrl-or-cmd'], function (exports, Ember, ApplicationRouteMixin, Configuration, ShortcutsRoute, ctrlOrCmd) {
    ...
    ApplicationRoute = Ember['default'].Route.extend(ApplicationRouteMixin['default'], ShortcutsRoute['default'], {
        shortcuts: shortcuts,
...
define('ghost/routes/posts/index', ['exports', 'simple-auth/mixins/authenticated-route-mixin', 'ghost/routes/mobile-index-route', 'ghost/mixins/loading-indicator', 'ghost/utils/mobile'], function (exports, AuthenticatedRouteMixin, MobileIndexRoute, loadingIndicator, mobileQuery) {

    'use strict';

    var PostsIndexRoute = MobileIndexRoute['default'].extend(AuthenticatedRouteMixin['default'], loadingIndicator['default'], {
        noPosts: false,
...
define('ghost/routes/reset', ['exports', 'ember', 'simple-auth/configuration', 'ghost/mixins/style-body', 'ghost/mixins/loading-indicator'], function (exports, Ember, Configuration, styleBody, loadingIndicator) {
...
define('ghost/routes/settings/index', ['exports', 'simple-auth/mixins/authenticated-route-mixin', 'ghost/routes/mobile-index-route', 'ghost/mixins/current-user-settings', 'ghost/utils/mobile'], function (exports, AuthenticatedRouteMixin, MobileIndexRoute, CurrentUserSettings, mobileQuery) {

    'use strict';

    var SettingsIndexRoute = MobileIndexRoute['default'].extend(AuthenticatedRouteMixin['default'], CurrentUserSettings['default'], {
        titleToken: "Settings",
...
define('ghost/routes/setup', ['exports', 'ember', 'simple-auth/configuration', 'ghost/mixins/style-body', 'ghost/mixins/loading-indicator'], function (exports, Ember, Configuration, styleBody, loadingIndicator) {
...
define('ghost/routes/signin', ['exports', 'ember', 'simple-auth/configuration', 'ghost/mixins/style-body', 'ghost/mixins/loading-indicator'], function (exports, Ember, Configuration, styleBody, loadingIndicator) {
...
define('ghost/routes/signup', ['exports', 'ember', 'simple-auth/configuration', 'ghost/mixins/style-body', 'ghost/mixins/loading-indicator'], function (exports, Ember, Configuration, styleBody, loadingIndicator) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        attribute(env, attrMorph4, element4, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/cobbspur"]));
        attribute(env, attrMorph5, element5, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/novaugust"]));
        attribute(env, attrMorph6, element6, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/felixrieseberg"]));
        attribute(env, attrMorph7, element7, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/rwjblue"]));
        attribute(env, attrMorph8, element8, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/acburdine"]));
        ...
        attribute(env, attrMorph13, element13, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/josephwegner"]));
        attribute(env, attrMorph14, element14, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/jgable"]));
        attribute(env, attrMorph15, element15, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/harryhope"]));
        attribute(env, attrMorph16, element16, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/nsfmc"]));
        attribute(env, attrMorph17, element17, "src", concat(env, [subexpr(env, context, "gh-path", ["admin", "/img/contributors"], {}), "/chilts"]));
        return fragment;
      }
    };
  }()));
...
define('ghost/templates/-nav-menu', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child1 = (function() {
      var child0 = (function() {
        return {
          ...
          build: function build(dom) {
            var el0 = dom.createDocumentFragment();
            var el1 = dom.createElement("i");
            dom.setAttribute(el1,"class","icon-gh");
            dom.appendChild(el0, el1);
      ...
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          var morph2 = dom.createMorphAt(dom.childAt(element1, [9]),0,0);
          block(env, morph0, context, "link-to", ["settings.about"], {"classNames": "gh-nav-menu-about dropdown-item js-nav-item", "role": "menuitem", "tabindex": "-1"}, child0, null);
          block(env, morph1, context, "link-to", ["settings.users.user", get(env, context, "session.user.slug")], {"classNames": "dropdown-item user-menu-profile js-nav-item", "role": "menuitem", "tabindex": "-1"}, child1, null);
    ...
    return {
      ...
      build: function build(dom) {
        ...
        dom.setAttribute(el1,"class","gh-nav");
        var el2 = dom.createTextNode("\n");
        dom.appendChild(el1, el2);
        var el2 = dom.createComment("");
        dom.appendChild(el1, el2);
        ...
        dom.setAttribute(el2,"class","gh-nav-body");
        var el3 = dom.createTextNode("\n        ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("section");
        dom.setAttribute(el3,"class","gh-nav-search");
        var el4 = dom.createTextNode("\n            ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("input");
        dom.setAttribute(el4,"class","gh-nav-search-input gh-input");
        ...
        dom.setAttribute(el4,"class","gh-nav-search-button");
        ...
        dom.setAttribute(el3,"class","gh-nav-list gh-nav-main");
        var el4 = dom.createTextNode("\n            ");
        dom.appendChild(el3, el4);
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("ul");
        dom.setAttribute(el3,"class","gh-nav-list gh-nav-settings");
        var el4 = dom.createTextNode("\n            ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("li");
        dom.setAttribute(el4,"class","gh-nav-list-h");
        ...
        dom.setAttribute(el2,"class","gh-nav-footer");
        var el3 = dom.createTextNode("\n        ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        dom.setAttribute(el3,"class","gh-autonav-toggle");
        var el4 = dom.createTextNode("\n            ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("i");
        dom.setAttribute(el4,"class","icon-minimise");
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("a");
        dom.setAttribute(el3,"class","gh-nav-footer-sitelink");
        dom.setAttribute(el3,"target","_blank");
        var el4 = dom.createTextNode("View blog ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("i");
        dom.setAttribute(el4,"class","icon-external");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n        ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        dom.setAttribute(el3,"class","gh-help-menu");
        var el4 = dom.createTextNode("\n");
        dom.appendChild(el3, el4);
      ...
      render: function render(context, env, contextualElement) {
        var dom = env.dom;
        var hooks = env.hooks, block = hooks.block, get = hooks.get, concat = hooks.concat, attribute = hooks.attribute;
        dom.detectNamespace(contextualElement);
        var fragment;
        if (env.useFragmentCache && dom.canClone) {
          if (this.cachedFragment === null) {
        ...
        var morph8 = dom.createMorphAt(dom.childAt(element6, [9]),0,0);
        var morph9 = dom.createMorphAt(dom.childAt(element6, [11]),0,0);
        var attrMorph0 = dom.createAttrMorph(element8, 'href');
        var morph10 = dom.createMorphAt(element9,1,1);
        var morph11 = dom.createMorphAt(element9,2,2);
        ...
        block(env, morph4, context, "link-to", ["settings.users"], {"classNames": "gh-nav-main-users"}, child4, null);
        block(env, morph5, context, "link-to", ["settings.general"], {"classNames": "gh-nav-settings-general"}, child5, null);
        block(env, morph6, context, "link-to", ["settings.navigation"], {"classNames": "gh-nav-settings-navigation"}, child6, null);
        block(env, morph7, context, "link-to", ["settings.tags"], {"classNames": "gh-nav-settings-tags"}, child7, null);
        block(env, morph8, context, "link-to", ["settings.code-injection"], {"classNames": "gh-nav-settings-code-injection"}, child8, null);
        block(env, morph9, context, "link-to", ["settings.labs"], {"classNames": "gh-nav-settings-labs"}, child9, null);
        attribute(env, attrMorph0, element8, "href", concat(env, [get(env, context, "config.blogUrl"), "/"]));
        block(env, morph10, context, "gh-dropdown-button", [], {"dropdownName": "help-menu", "tagName": "div"}, child10, null);
        block(env, morph11, context, "gh-dropdown", [], {"tagName": "div", "classNames": "dropdown", "name": "help-menu", "closeOnClick": "true"}, child11, null);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          inline(env, morph0, context, "partial", ["nav-menu"], {});
          return fragment;
        }
      };
    }());
    return {
      ...
      build: function build(dom) {
        ...
        dom.appendChild(el0, el1);
        var el1 = dom.createElement("div");
        dom.setAttribute(el1,"class","gh-viewport");
        var el2 = dom.createTextNode("\n\n");
        dom.appendChild(el1, el2);
        var el2 = dom.createComment("");
        dom.appendChild(el1, el2);
        ...
        dom.setAttribute(el2,"id","gh-main");
        dom.setAttribute(el2,"class","gh-main");
        dom.setAttribute(el2,"role","main");
        var el3 = dom.createTextNode("\n        ");
        dom.appendChild(el2, el3);
        var el3 = dom.createComment("");
        dom.appendChild(el2, el3);
      ...
      render: function render(context, env, contextualElement) {
        var dom = env.dom;
        var hooks = env.hooks, inline = hooks.inline, get = hooks.get, block = hooks.block, attribute = hooks.attribute, content = hooks.content;
        dom.detectNamespace(contextualElement);
        var fragment;
        if (env.useFragmentCache && dom.canClone) {
          if (this.cachedFragment === null) {
        ...
        var attrMorph0 = dom.createAttrMorph(element1, 'data-notification-count');
        ...
        attribute(env, attrMorph0, element1, "data-notification-count", get(env, context, "topNotificationCount"));
...
define('ghost/templates/editor/edit', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        var dom = env.dom;
        var hooks = env.hooks, get = hooks.get, inline = hooks.inline, subexpr = hooks.subexpr, concat = hooks.concat, attribute = hooks.attribute, element = hooks.element;
        dom.detectNamespace(contextualElement);
        var fragment;
        if (env.useFragmentCache && dom.canClone) {
          if (this.cachedFragment === null) {
        ...
        var morph2 = dom.createMorphAt(dom.childAt(element5, [1, 1]),0,0);
        ...
        attribute(env, attrMorph0, element1, "class", concat(env, ["entry-markdown js-entry-markdown ", subexpr(env, context, "unless", [get(env, context, "isPreview"), "active"], {})]));
        element(env, element2, context, "action", ["togglePreview", false], {});
        element(env, element3, context, "action", ["openModal", "markdown"], {});
        ...
        attribute(env, attrMorph1, element4, "class", concat(env, ["entry-preview js-entry-preview ", subexpr(env, context, "if", [get(env, context, "isPreview"), "active"], {})]));
        element(env, element5, context, "action", ["togglePreview", true], {});
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        attribute(env, attrMorph0, element5, "class", concat(env, ["content-list js-content-list ", subexpr(env, context, "if", [get(env, context, "postListFocused"), "keyboard-focused"], {})]));
        block(env, morph0, context, "view", ["paginated-scroll-box"], {"tagName": "section", "classNames": "content-list-content js-content-scrollbox"}, child0, null);
        attribute(env, attrMorph1, element6, "class", concat(env, ["content-preview js-content-preview ", subexpr(env, context, "if", [get(env, context, "postContentFocused"), "keyboard-focused"], {})]));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        dom.insertBoundary(fragment, null);
        attribute(env, attrMorph0, element3, "class", concat(env, [subexpr(env, context, "if", [get(env, context, "model.featured"), "featured icon-star", "unfeatured icon-star"], {})]));
        element(env, element3, context, "action", ["toggleFeatured"], {});
        block(env, morph0, context, "if", [get(env, context, "isPublished")], {}, child0, child1);
        block(env, morph1, context, "if", [get(env, context, "model.author.name")], {}, child2, child3);
        block(env, morph2, context, "link-to", ["editor.edit", get(env, context, "model")], {"class": "btn btn-default post-edit"}, child4, null);
        block(env, morph3, context, "view", ["content-preview-content-view"], {"tagName": "section"}, child5, null);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      build: function build(dom) {
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("header");
        dom.setAttribute(el2,"class","gh-about-header");
        var el3 = dom.createTextNode("\n        ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("img");
        dom.setAttribute(el3,"class","gh-logo");
        dom.setAttribute(el3,"alt","Ghost");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n        ");
        dom.appendChild(el2, el3);
        var el3 = dom.createComment(" TODO: fix about notifications ");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n        ");
        dom.appendChild(el2, el3);
        var el3 = dom.createComment("");
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("section");
        dom.setAttribute(el2,"class","gh-env-details");
        var el3 = dom.createTextNode("\n        ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("ul");
        dom.setAttribute(el3,"class","gh-env-list");
        var el4 = dom.createTextNode("\n            ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("li");
        dom.setAttribute(el4,"class","gh-env-list-version");
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("strong");
        var el6 = dom.createTextNode("Environment");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode(" ");
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("li");
        dom.setAttribute(el4,"class","gh-env-list-database-type");
        var el5 = dom.createElement("strong");
        var el6 = dom.createTextNode("Database");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode(" ");
        dom.appendChild(el4, el5);
        ...
        var el4 = dom.createElement("li");
        var el5 = dom.createElement("strong");
        var el6 = dom.createTextNode("Mail");
        dom.appendChild(el5, el6);
        dom.appendChild(el4, el5);
        var el5 = dom.createTextNode(" ");
        dom.appendChild(el4, el5);
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        dom.setAttribute(el3,"class","gh-env-help");
        var el4 = dom.createTextNode("\n            ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("a");
        dom.setAttribute(el4,"href","http://support.ghost.org");
        dom.setAttribute(el4,"class","btn btn-minor");
        dom.setAttribute(el4,"target","_blank");
        var el5 = dom.createTextNode("User Documentation");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n            ");
        dom.appendChild(el3, el4);
        var el4 = dom.createElement("a");
        dom.setAttribute(el4,"href","https://ghost.org/slack/");
        dom.setAttribute(el4,"class","btn btn-minor");
        dom.setAttribute(el4,"target","_blank");
        var el5 = dom.createTextNode("Get Help With Ghost");
        dom.appendChild(el4, el5);
        dom.appendChild(el3, el4);
        var el4 = dom.createTextNode("\n        ");
        dom.appendChild(el3, el4);
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("section");
        dom.setAttribute(el2,"class","gh-credits");
        var el3 = dom.createTextNode("\n        ");
        dom.appendChild(el2, el3);
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("section");
        dom.setAttribute(el3,"class","gh-contributors");
        var el4 = dom.createTextNode("\n            ");
        dom.appendChild(el3, el4);
        var el4 = dom.createComment("");
        dom.appendChild(el3, el4);
        ...
        dom.setAttribute(el3,"class","btn btn-blue btn-lg");
        ...
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("footer");
        dom.setAttribute(el2,"class","gh-copyright-info");
        var el3 = dom.createTextNode("\n        Copyright 2013 - 2015 Ghost Foundation, released under the ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("a");
        dom.setAttribute(el3,"href","https://github.com/TryGhost/Ghost/blob/master/LICENSE");
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("a");
        dom.setAttribute(el3,"href","https://ghost.org/");
        var el4 = dom.createTextNode("Ghost");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode(" is a trademark of the ");
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("a");
        dom.setAttribute(el3,"href","https://ghost.org/about/");
        var el4 = dom.createTextNode("Ghost Foundation");
        dom.appendChild(el3, el4);
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode(".\n    ");
        dom.appendChild(el2, el3);
      ...
      render: function render(context, env, contextualElement) {
        ...
        inline(env, morph0, context, "gh-notifications", [], {"location": "settings-about-upgrade", "notify": "updateNotificationChange"});
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      build: function build(dom) {
        ...
        dom.setAttribute(el2,"class","view-title");
      ...
      render: function render(context, env, contextualElement) {
        ...
        block(env, morph0, context, "each", [get(env, context, "model")], {"itemController": "settings/app", "keyword": "appController"}, child0, null);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var element1 = dom.childAt(fragment, [2, 1, 1]);
        var morph0 = dom.createMorphAt(dom.childAt(element1, [3]),5,5);
        var morph1 = dom.createMorphAt(dom.childAt(element1, [5]),5,5);
        element(env, element0, context, "action", ["save"], {});
        inline(env, morph0, context, "gh-cm-editor", [], {"id": "ghost-head", "class": "gh-input settings-code-editor", "name": "codeInjection[ghost_head]", "type": "text", "value": get(env, context, "model.ghost_head")});
        inline(env, morph1, context, "gh-cm-editor", [], {"id": "ghost-foot", "class": "gh-input settings-code-editor", "name": "codeInjection[ghost_foot]", "type": "text", "value": get(env, context, "model.ghost_foot")});
        return fragment;
      }
    };
  }()));
...
define('ghost/templates/settings/general', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        var dom = env.dom;
        var hooks = env.hooks, element = hooks.element, get = hooks.get, inline = hooks.inline, block = hooks.block, concat = hooks.concat, attribute = hooks.attribute;
        dom.detectNamespace(contextualElement);
        var fragment;
        if (env.useFragmentCache && dom.canClone) {
          if (this.cachedFragment === null) {
        ...
        var element9 = dom.childAt(element8, [7, 3]);
        var morph0 = dom.createMorphAt(dom.childAt(element6, [1]),3,3);
        var morph1 = dom.createMorphAt(element7,3,3);
        var morph2 = dom.createMorphAt(dom.childAt(element7, [5]),1,1);
        var morph3 = dom.createMorphAt(dom.childAt(element5, [3]),3,3);
        var morph4 = dom.createMorphAt(dom.childAt(element5, [5]),3,3);
        var morph5 = dom.createMorphAt(dom.childAt(element8, [1]),3,3);
        var morph6 = dom.createMorphAt(dom.childAt(element8, [3]),3,3);
        var morph7 = dom.createMorphAt(dom.childAt(element8, [5, 3]),1,1);
        var morph8 = dom.createMorphAt(element9,1,1);
        var attrMorph0 = dom.createAttrMorph(element9, 'data-select-text');
        var morph9 = dom.createMorphAt(dom.childAt(element8, [9, 3]),1,1);
        var morph10 = dom.createMorphAt(element8,11,11);
        element(env, element4, context, "action", ["save"], {});
        inline(env, morph0, context, "input", [], {"id": "blog-title", "class": "gh-input", "name": "general[title]", "type": "text", "value": get(env, context, "model.title")});
        inline(env, morph1, context, "textarea", [], {"id": "blog-description", "class": "gh-input", "name": "general[description]", "value": get(env, context, "model.description")});
        inline(env, morph2, context, "gh-count-characters", [get(env, context, "model.description")], {});
        block(env, morph3, context, "if", [get(env, context, "model.logo")], {}, child0, child1);
        block(env, morph4, context, "if", [get(env, context, "model.cover")], {}, child2, child3);
        inline(env, morph5, context, "input", [], {"id": "email-address", "class": "gh-input", "name": "general[email-address]", "type": "email", "value": get(env, context, "model.email"), "autocapitalize": "off", "autocorrect": "off"});
        ...
        attribute(env, attrMorph0, element9, "data-select-text", concat(env, [get(env, context, "selectedTheme.label")]));
        ...
        block(env, morph10, context, "if", [get(env, context, "model.isPrivate")], {}, child4, null);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        block(env, morph0, context, "gh-form", [], {"id": "settings-import", "enctype": "multipart/form-data"}, child0, null);
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      build: function build(dom) {
        ...
        dom.appendChild(el0, el1);
        var el1 = dom.createElement("section");
        dom.setAttribute(el1,"class","view-content settings-navigation");
        var el2 = dom.createTextNode("\n    ");
        dom.appendChild(el1, el2);
        var el2 = dom.createElement("form");
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph0 = dom.createMorphAt(dom.childAt(fragment, [2, 1]),1,1);
        element(env, element0, context, "action", ["save"], {});
        block(env, morph0, context, "each", [get(env, context, "navigationItems")], {"keyword": "navItem"}, child0, null);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        element(env, element1, context, "action", ["newTag"], {});
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      build: function build(dom) {
        ...
        dom.appendChild(el0, el1);
        var el1 = dom.createElement("section");
        dom.setAttribute(el1,"class","view-content settings-users");
        var el2 = dom.createTextNode("\n\n");
        dom.appendChild(el1, el2);
        var el2 = dom.createComment("");
        dom.appendChild(el1, el2);
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph1 = dom.createMorphAt(dom.childAt(element9, [3]),3,3);
        element(env, element8, context, "action", ["openModal", "invite-new-user"], {});
        block(env, morph0, context, "if", [get(env, context, "invitedUsers")], {}, child0, null);
        block(env, morph1, context, "each", [get(env, context, "activeUsers")], {"itemController": "settings/users/user", "keyword": "user"}, child1, null);
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      build: function build(dom) {
        ...
        dom.setAttribute(el3,"class","icon-arrow-right");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode(" ");
        dom.appendChild(el2, el3);
        var el3 = dom.createComment("");
      ...
      render: function render(context, env, contextualElement) {
        var dom = env.dom;
        var hooks = env.hooks, block = hooks.block, content = hooks.content, get = hooks.get, element = hooks.element, attribute = hooks.attribute, inline = hooks.inline;
        dom.detectNamespace(contextualElement);
        var fragment;
        if (env.useFragmentCache && dom.canClone) {
          if (this.cachedFragment === null) {
        ...
        var element16 = dom.childAt(element13, [11]);
        var element17 = dom.childAt(element8, [9]);
        var element18 = dom.childAt(element17, [7, 1]);
        var morph0 = dom.createMorphAt(element2,0,0);
        ...
        var attrMorph1 = dom.createAttrMorph(element11, 'style');
        var morph3 = dom.createMorphAt(dom.childAt(element11, [0]),0,0);
        var morph4 = dom.createMorphAt(dom.childAt(element9, [3]),3,3);
        var morph5 = dom.createMorphAt(element14,3,3);
        var morph6 = dom.createMorphAt(element15,0,0);
        var morph7 = dom.createMorphAt(element15,2,2);
        var morph8 = dom.createMorphAt(dom.childAt(element13, [3]),3,3);
        var morph9 = dom.createMorphAt(element13,5,5);
        var morph10 = dom.createMorphAt(dom.childAt(element13, [7]),3,3);
        var morph11 = dom.createMorphAt(dom.childAt(element13, [9]),3,3);
        var morph12 = dom.createMorphAt(element16,3,3);
        var morph13 = dom.createMorphAt(dom.childAt(element16, [5]),1,1);
        var morph14 = dom.createMorphAt(element17,1,1);
        var morph15 = dom.createMorphAt(dom.childAt(element17, [3]),3,3);
        var morph16 = dom.createMorphAt(dom.childAt(element17, [5]),3,3);
        block(env, morph0, context, "link-to", ["settings.users"], {}, child0, null);
        content(env, morph1, context, "user.name");
        block(env, morph2, context, "if", [get(env, context, "view.userActionsAreVisible")], {}, child1, null);
        element(env, element4, context, "action", ["save"], {});
        attribute(env, attrMorph0, element6, "style", get(env, context, "coverImageBackground"));
        element(env, element7, context, "action", ["openModal", "upload", get(env, context, "user"), "cover"], {});
        attribute(env, attrMorph1, element11, "style", get(env, context, "userImageBackground"));
        content(env, morph3, context, "user.name");
        element(env, element12, context, "action", ["openModal", "upload", get(env, context, "user"), "image"], {});
        inline(env, morph4, context, "input", [], {"value": get(env, context, "user.name"), "id": "user-name", "class": "gh-input user-name", "placeholder": "Full Name", "autocorrect": "off"});
        inline(env, morph5, context, "gh-input", [], {"class": "gh-input user-name", "id": "user-slug", "value": get(env, context, "slugValue"), "name": "user", "focus-out": "updateSlug", "placeholder": "Slug", "selectOnClick": "true", "autocorrect": "off"});
        content(env, morph6, context, "gh-blog-url");
        content(env, morph7, context, "slugValue");
        inline(env, morph8, context, "input", [], {"type": "email", "value": get(env, context, "user.email"), "id": "user-email", "class": "gh-input", "placeholder": "Email Address", "autocapitalize": "off", "autocorrect": "off", "autocomplete": "off"});
        block(env, morph9, context, "if", [get(env, context, "view.rolesDropdownIsVisible")], {}, child2, null);
        inline(env, morph10, context, "input", [], {"type": "text", "value": get(env, context, "user.location"), "id": "user-location", "class": "gh-input"});
        inline(env, morph11, context, "input", [], {"type": "url", "value": get(env, context, "user.website"), "id": "user-website", "class": "gh-input", "autocapitalize": "off", "autocorrect": "off", "autocomplete": "off"});
        inline(env, morph12, context, "textarea", [], {"id": "user-bio", "class": "gh-input", "value": get(env, context, "user.bio")});
        ...
        inline(env, morph15, context, "input", [], {"value": get(env, context, "user.newPassword"), "type": "password", "id": "user-password-new", "class": "gh-input"});
        inline(env, morph16, context, "input", [], {"value": get(env, context, "user.ne2Password"), "type": "password", "id": "user-new-password-verification", "class": "gh-input"});
        element(env, element18, context, "action", ["password"], {});
        return fragment;
      }
    };
  }()));
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        dom.setAttribute(el7,"class","icon-image ");
...
define('ghost/views/settings/users/index', ['exports', 'ghost/views/settings/content-base'], function (exports, BaseView) {

	'use strict';

	var SettingsUserIndexView = BaseView['default'].extend();

	exports['default'] = SettingsUserIndexView;

});
define('ghost/views/settings/users/user', ['exports', 'ember', 'ghost/views/settings/content-base'], function (exports, Ember, BaseView) {

    'use strict';

    var SettingsUserView = BaseView['default'].extend({
...
if (runningTests) {
  ...
  require("ghost/app")["default"].create({"LOG_ACTIVE_GENERATION":true,"LOG_TRANSITIONS":true,"LOG_TRANSITIONS_INTERNAL":true,"LOG_VIEW_LOOKUPS":true,"name":"ghost","version":"0.0.0.be0f8d2a"});
}
